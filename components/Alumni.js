  ...
  return (
    <div className="md:w-3/4 flex flex-col md:h-[450px] mt-10">
      ...
      <div className="flex justify-center">
        {dataAlumni.map((alumnus, id) => (
          ...
          >
            ...
            <div className="bg-gradient bg-gradient-to-br from-gray-300 to-transparent bg-opacity-20 rounded-lg shadow-2xl card border px-5 py-5">
      ...
      <div className="flex md:flex-row items-center justify-center lg:space-x-4 lg:mt-8 space-x-2 mt-4">
        {dataAlumni.map((alumnus, id) => (
          <button key={id} onClick={() => setActive(alumnus.nama)}>
            <img
              src={alumnus.image}
