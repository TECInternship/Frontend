              ...
              <div className="pt-6 md:p-12 flex justify-center">
                <div className="flex flex-col md:flex-row relative gap-4 w-full mx-2">
                  ...
                  <div className="flex flex-row md:flex-col justify-between text-xs sm:text-sm md:text-base">
                    <div class={active === "1" && "my-1"} className="">Data diri</div>
                    <div class={active === "2" && "my-1"} className="absolute w-full text-center md:relative md:w-auto md:text-left">Pembayaran</div>
                    <div class={active === "3" && "my-1"} className="absolute w-full text-right md:relative md:w-auto md:text-left">Konfirmasi</div>
                  </div>
                </div>
              </div>
            </div>
